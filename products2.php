...
<div id="promotions" data-role="content"  >
	...
	<div style="background-color:#ff0000;height:190px;box-shadow: 2px 3px 2px #888888;">
		...
		<a onClick="document.location.href='products_cake2.php'">
	...
	<div style="background-color:#ff0000;height:190px;box-shadow: 2px 3px 2px #888888;">
		...
		<a onClick="document.location.href='products_rolls2.php'">
		<div style="background-color:#ffffff;width: 100%;height: 80%;">
		<center>
	...
	<br/>
		...
		<a onClick="document.location.href='products_dedication2.php'">
		<div style="background-color:#ffffff;width: 100%;height: 80%;">
		<center>
	...
	<br/>
		...
		<a onClick="document.location.href='products_pastries2.php'">
		<div style="background-color:#ffffff;width: 100%;height: 80%;">
		<center>
