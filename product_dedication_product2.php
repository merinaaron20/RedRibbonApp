...
include 'config.php';
	...
	$id=$_GET['id'];
	$sql="SELECT * FROM tbl_dedication WHERE id='$id'";
...
<div data-role="header" data-position="fixed">
	...
	<a onClick="document.location.href='products_dedication2.php'" data-role="button" class="custom-btn" data-icon="back"><span style="font-size:12pt;">&nbsp;Back</a>
</div>
...
<br/>
		...
		<div style="background-color:#a9a9a9;height:100%;box-shadow: 2px 3px 2px #888888;">		
			<div style="background-color:#ffffff;width: 100%;height: 100%;padding-top:1px;" >
				...
				<p style="padding-left:15px;padding-right:15px;"><?php echo $rows['product_detail_1']; ?></p>	
				<p style="padding-left:15px;padding-right:15px;"><?php echo $rows['product_detail_2']; ?></p>
				<p style="padding-left:15px;padding-right:15px;"><?php echo $rows['product_detail_3']; ?></p>			
			</div>
		</div>
