...
include 'config.php';
	...
	$id=$_GET['id'];
	$sql="SELECT * FROM tbl_rolls WHERE id='$id'";
...
<div data-role="header" data-position="fixed">
	...
	<a onClick="document.location.href='products_rolls2.php'" data-role="button" class="custom-btn" data-icon="back"><span style="font-size:12pt;">&nbsp;Back</a>
</div>
