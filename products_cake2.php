...
$sql="SELECT * FROM tbl_cakes ORDER BY id ASC";
            ...
            <table >
			 ...
			 <br>
				<div id="bestseller1" class="item" style="background-color:#ffffff;height:100%;width:100%;box-shadow: 2px 3px 2px #888888;">
						...
						<center>
						<a onClick="document.location.href='product_cake_product2.php?id=<?php echo $row['id']; ?>'"  >
						<?php echo '<img src="data:image/png;base64,' . base64_encode($row['cake_image']) . '" width="80%" height="50%" />'; ?><br /></a>
						</center>
						<div style="background-color:#fcfcfc;width: 100%;height: 100%;" >
						<p style="font-size:12pt;color:red;padding-top:10px;padding-left:10px;"><?php echo $row['cake_name']; ?></p>
