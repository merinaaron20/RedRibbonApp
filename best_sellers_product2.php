...
include 'config.php';
	...
	$id=$_GET['id'];
	$sql="SELECT * FROM tbl_bestsellers WHERE id='$id'";
...
<div data-role="header" data-position="fixed">
	...
	<a onClick="document.location.href='best_sellers2.php'" data-role="button" class="custom-btn" data-icon="back"><span style="font-size:12pt;">&nbsp;Back</a>
</div>
